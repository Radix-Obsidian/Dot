...
import { loadMemoryStatus } from "./controllers/memory";
import {
...
export async function refreshActiveTab(host: SettingsHost) {
  ...
  if (host.tab === "memory") await loadMemoryStatus(host as unknown as OpenClawApp);
  if (host.tab === "nodes") {
...
export function inferBasePath() {
  ...
  const configured = window.__DOT_AI_CONTROL_UI_BASE_PATH__;
