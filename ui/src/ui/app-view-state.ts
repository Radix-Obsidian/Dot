...
export type AppViewState = {
  ...
  memoryStatus: import("./views/memory").MemoryStatusData | null;
  memoryError: string | null;
  memorySearchQuery: string;
  memorySearchResults: import("./views/memory").MemorySearchResultItem[];
  memorySearching: boolean;
  memorySyncing: boolean;
  onboardingStep: import("./views/onboarding").OnboardingStep;
