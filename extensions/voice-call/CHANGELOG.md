...
- Version alignment with core dot release numbers.
...
- First public release of the @dot/voice-call plugin.
...
- CLI: `dot voicecall` commands (call/start/continue/speak/end/status/tail/expose).
