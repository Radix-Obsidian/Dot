...
Nostr DM channel plugin for dot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to dot. It enables your bot to:
...
# Configure dot to use local relay
