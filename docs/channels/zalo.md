...
- Install via CLI: `dot plugins install @dot/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `dot plugins install ./extensions/zalo`
   - From npm (if published): `dot plugins install @dot/zalo`
...
- Approve via:
  - `dot pairing list zalo`
  - `dot pairing approve zalo <CODE>`
...
- Example: `dot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `dot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `dot logs --follow`
