...
read_when:
  - You are building a dot plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (dot.plugin.json)

Every plugin **must** ship a `dot.plugin.json` file in the **plugin root**.
dot uses this manifest to validate configuration **without executing plugin
