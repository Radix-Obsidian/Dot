---
summary: "Use Qwen OAuth (free tier) in dot"
read_when:
  - You want to use Qwen with dot
...
```bash
dot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, dot will sync credentials
