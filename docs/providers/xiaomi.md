---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with dot"
read_when:
  - You want Xiaomi MiMo models in dot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). dot uses
...
```bash
dot onboard --auth-choice xiaomi-api-key
# or non-interactive
dot onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
