...
dot ships three update channels:
...
When you **explicitly** switch channels with `--channel`, dot also aligns
the install method:
...
When you switch channels with `dot update`, dot also syncs plugin sources:
