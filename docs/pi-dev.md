...
This guide summarizes a sane workflow for working on the pi integration in dot.
...
- Trigger the agent directly:
  - `pnpm dot agent --message "Hello" --thinking low`
...
State lives under the dot state directory. Default is `~/.dot`. If `dot_STATE_DIR` is set, use that directory instead.
...
- https://docs.dot.ai/testing
- https://docs.dot.ai/start/getting-started
