...
This page ties together how dot handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. dot keeps a
...
dot separates the **prompt body** from the **command body**:
...
dot can expose or hide model reasoning:
