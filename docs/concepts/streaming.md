...
dot has two separate “streaming” layers:
...
When block streaming is enabled, dot can **merge consecutive block chunks**
...
When draft streaming is active, dot disables block streaming for that reply to avoid double-streaming.
