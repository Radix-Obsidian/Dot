---
summary: "Frequently asked questions about dot setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up dot?](#whats-the-recommended-way-to-install-and-set-up-dot)
  ...
  - [I can't access docs.dot.ai (SSL error). What now?](#i-cant-access-docsdotai-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or dot not recognized](#windows-install-says-git-not-found-or-dot-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install dot on Linux?](#how-do-i-install-dot-on-linux)
  - [How do I install dot on a VPS?](#how-do-i-install-dot-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask dot to update itself?](#can-i-ask-dot-to-update-itself)
  ...
  - [If I buy a Mac mini to run dot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-dot-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different dot instances?](#can-multiple-people-use-one-whatsapp-number-with-different-dot-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run dot on a dedicated machine?](#how-important-is-it-to-run-dot-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run dot in a VM and what are the requirements](#can-i-run-dot-in-a-vm-and-what-are-the-requirements)
- [What is dot?](#what-is-dot)
  - [What is dot, in one paragraph?](#what-is-dot-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for dot](#what-are-the-top-five-everyday-use-cases-for-dot)
  - [Can dot help with lead gen outreach ads and blogs for a SaaS](#can-dot-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can dot run tasks on a schedule or continuously in the background?](#can-dot-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with dot saved locally?](#is-all-data-used-with-dot-saved-locally)
  - [Where does dot store its data?](#where-does-dot-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall dot?](#how-do-i-completely-uninstall-dot)
...
- [Config basics](#config-basics)
  ...
  - [Can the dot browser run headless?](#can-the-dot-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two dot instances talk to each other (local + VPS)?](#can-two-dot-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does dot load environment variables?](#how-does-dot-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of dot instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-dot-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset dot but keep it installed?](#how-do-i-completely-reset-dot-but-keep-it-installed)
  ...
  - [Why doesn’t dot reply in a group?](#why-doesnt-dot-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do dot, Flawd, and Krill use for models?](#what-do-dot-flawd-and-krill-use-for-models)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `dot gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-dot-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `dot gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-dot-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run dot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-dot-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart dot?](#i-closed-my-terminal-on-windows-how-do-i-restart-dot)
  ...
  - [ELI5: `dot gateway restart` vs `dot gateway`](#eli5-dot-gateway-restart-vs-dot-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose dot to inbound DMs?](#is-it-safe-to-expose-dot-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/dot/dot-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ```bash
   dot health --json
   dot health --verbose   # shows the target URL + config path on errors
   ```
...
This installs dot **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/dot/dot/issues
https://github.com/dot/dot/pulls
...
- `dot status`: quick snapshot of gateway/agent health + basic config.
- `dot models status`: checks provider auth + model availability.
- `dot doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `dot status --all`, `dot logs --follow`,
`dot gateway status`, `dot health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up dot
...
If you don’t have a global install yet, run it via `pnpm dot onboard`.
...
- If it asks for auth, run `dot dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `dot_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `dot gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `dot gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `dot dashboard`.
...
1. Install dot on the new machine.
2. Copy `$dot_STATE_DIR` (default: `~/.dot`) from the old machine.
3. Copy your workspace (default: `~/.dot/workspace`).
4. Run `dot doctor` and restart the Gateway service.
...
under `~/.dot/` (for example `~/.dot/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-dot-store-its-data),
...
https://github.com/dot/dot/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.dot.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.dot.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.dot.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsdotai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/dot/dot/tree/main/docs
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://dot.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://dot.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://dot.ai/install.ps1
...
```bash
curl -fsSL https://dot.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://dot.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://dot.ai/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or dot not recognized
...
**2) dot is not recognized after install**
...
### Can I ask dot to update itself
...
dot update
dot update status
dot update --channel stable|beta|dev
dot update --tag <dist-tag|version>
dot update --no-restart
```

If you must automate from an agent:

```bash
dot update --yes --no-restart
dot gateway restart
```
...
`dot onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run dot with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `dot models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `dot models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `dot models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. dot no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so dot can keep replying while a provider is rate‑limited.
...
dot supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. dot fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `dot.json`.

Steps:

1. Enable the plugin: `dot plugins enable google-gemini-cli-auth`
2. Login: `dot models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. dot needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. dot runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. dot’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run dot can I connect it to my MacBook Pro
...
- Use `dot nodes status` / `dot nodes list` to see it.
...
- DM your bot, then run `dot logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different dot instances
...
If you run dot via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the dot code install. Your state
(`~/.dot`) and workspace (`~/.dot/workspace`) stay untouched.
...
**dot-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run dot on a dedicated machine
...
dot is lightweight. For a basic Gateway + one chat channel:
...
### Can I run dot in a VM and what are the requirements
...
### What is dot in one paragraph

dot is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

dot is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for dot
...
### Can dot help with lead gen outreach ads and blogs for a SaaS
...
dot draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

dot is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use dot when you
...
Showcase: https://dot.ai/showcase

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.dot/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.dot/dot.json`). Precedence is `<workspace>/skills` > `~/.dot/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.dot/dot.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.dot/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which dot treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `dot_SKIP_CRON` is not set.
...
```bash
dot cron run <jobId> --force
dot cron runs --id <jobId> --limit 50
```
...
### Can dot run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.dot.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-dot-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. dot can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.dot/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: { "dot": { "os": ["darwin", "linux"], "requires": { "bins": ["imsg"] } } }
   ---
   ```
4. Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (dot only needs stdio). See [iMessage](/channels/imessage).
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured dot workspace); dot treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.dot/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
dot memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

dot also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, dot auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, dot
prefers `local`.
...
### Is all data used with dot saved locally

No - **dot’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.dot` + your workspace directory).
...
### Where does dot store its data

Everything lives under `$dot_STATE_DIR` (default: `~/.dot`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$dot_STATE_DIR/dot.json`                             | Main config (JSON5)                                          |
| `$dot_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$dot_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$dot_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$dot_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$dot_STATE_DIR/agents/`                                   | Per‑agent state (agentDir + sessions)                        |
| `$dot_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$dot_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single‑agent path: `~/.dot/agent/*` (migrated by `dot doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.dot/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.dot`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.dot`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.dot/skills`).

Default workspace is `~/.dot/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.dot/workspace" } },
}
```
...
Do **not** commit anything under `~/.dot` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall dot
...
`workspace` to the repo root. The dot repo is just source code; keep the
...
dot reads an optional **JSON5** config from `$dot_CONFIG_PATH` (default: `~/.dot/dot.json`):

```
$dot_CONFIG_PATH
```

If the file is missing, it uses safe‑ish defaults (including a default workspace of `~/.dot/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `dot_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `dot doctor --generate-gateway-token`.
...
key. **Recommended:** run `dot configure --section web` to store it in
...
- Daemons read env vars from `~/.dot/.env` (or the service environment).
...
### Can the dot browser run headless
...
- Gateway is running: `dot gateway status`
- Gateway health: `dot status`
- Channel health: `dot channels status`
...
### Can two dot instances talk to each other local VPS
...
`dot agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
dot agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.dot/dot.json`).
- If you have no backup, re-run `dot doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `dot config set` for small changes.
- Use `dot configure` for interactive edits.
...
### How does dot load environment variables

dot reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.dot/.env` (aka `$dot_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.dot/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`dot_LOAD_SHELL_ENV=1`, `dot_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`dot models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means dot won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.dot/.env`:
   ```
...
### Is there a way to make a team of dot instances one CEO and many agents
...
### How do I completely reset dot but keep it installed
...
```bash
dot reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `dot_PROFILE`), reset each state dir (defaults are `~/.dot-<profile>`).
- Dev reset: `dot gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), dot skips the heartbeat run to save API calls.
...
No. dot runs on **your own account**, so if you’re in the group, dot can see it.
...
```bash
dot directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt dot reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.dot/agents/<agentId>/sessions/`.
...
- Use `dot doctor` to spot stray workspaces and profile mismatches.
...
dot’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, dot currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `dot models set ...` (updates just model config)
- `dot configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.dot/dot.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `dot doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do dot, Flawd, and Krill use for models

- **dot + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-5`) - see [Anthropic](/providers/anthropic).
...
Yes. dot ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.dot/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `dot agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so dot can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.dot/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.dot/agent/*` (migrated by `dot doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.dot/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `dot models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `dot models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `dot models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.dot/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    dot models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), dot will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: dot now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
dot uses provider‑prefixed IDs like:
...
dot may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `dot models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
dot models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
dot models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
dot models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
dot models auth order set --provider anthropic --agent main anthropic:default
```
...
```
--port > dot_GATEWAY_PORT > gateway.port > default 18789
```

### Why does dot gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `dot gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does dot gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `dot_STATE_DIR` mismatch).

Fix:

```bash
dot gateway install --force
```
...
dot enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `dot gateway --port <port>`.

### How do I run dot in remote mode client connects to a Gateway elsewhere
...
- `dot gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `dot.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:

- Fastest: `dot dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `dot doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `dot_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `dot status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `dot_CONFIG_PATH` (per‑instance config)
- `dot_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `dot --profile <name> …` per instance (auto-creates `~/.dot-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `dot --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.dot.*`, `dot-gateway-<profile>.service`, `dot Gateway (<profile>)`).
...
```
dot tui --url ws://<host>:18789 --token <token>
```
...
- macOS: `$dot_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.dot/logs/...`; profiles use `~/.dot-<profile>/logs/...`)
- Linux: `journalctl --user -u dot-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "dot Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `dot gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart dot
...
1. Is the Gateway running? `dot gateway status`
2. Is the Gateway healthy? `dot status`
3. Does the UI have the right token? `dot dashboard`
...
```bash
dot channels status
dot channels logs --channel telegram
```
...
### ELI5 dot gateway restart vs dot gateway

- `dot gateway restart`: restarts the **background service** (launchd/systemd).
- `dot gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `dot gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [dot assistant setup](/start/dot) and [Agent send](/tools/agent-send).

CLI sending:

```bash
dot message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose dot to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `dot pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `dot pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `dot doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. dot only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
dot pairing approve whatsapp <code>
```

List pending requests:

```bash
dot pairing list whatsapp
```
...
dot blocks **cross‑provider** messaging by default. If a tool call is bound
...
**A:** In dot, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn’t find Anthropic credentials in the expected `auth-profiles.json` for the agent that’s running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/dot/dot/discussions).
