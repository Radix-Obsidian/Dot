## dot Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_dot-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm dot gateway --port 18789 --verbose
```
