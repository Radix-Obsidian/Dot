---
name: bluebubbles
description: Build or update the BlueBubbles external channel plugin for dot (extension package, REST send/probe, webhook inbound).
---
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `dot/plugin-sdk` helpers.
